...
describe('PatientDetailPage', () => {
  it('shows patient name and visits', async () => {
    vi.stubGlobal('fetch', vi.fn((url: string) => {
      if (url === '/api/patients/1') return Promise.resolve({ ok: true, status: 200, json: async () => ({ id: 1, name: 'Ana', date_of_birth: '1990-01-01', gender: 'female', phone: null, employment_status: null, income: null, created_at: 'x' }) } as Response)
